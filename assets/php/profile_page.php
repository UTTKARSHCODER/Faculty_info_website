      ...
      <div class="content-box">
          ...
          <nav class="navbar">
            <ul class="navbar-nav text-dark">
              ...
              <a href="profile_page.php" style = "text-decoration: none;"><li class="nav-item active text-white">Profile</li></a>
        ...
        if (isset($_SESSION['userEmail'])) {
            ...
            $result = mysqli_query($conn,$sql); ?>
                ...
                <div class = "col-12 color-gray">
                    ...
                    <h4 class = "mt-3 left-margin-h4">Award Certificate<span>
            ...
            <?php }
                ...
                <a href = "logout.php" class = "text-center edit">You are not authorized. Log through User from Top Right dropdown.</a>
                <?php
            }
        ?>
    </div>
