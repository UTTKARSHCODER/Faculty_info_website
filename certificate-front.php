      ...
      <div class="content-box">
          ...
          <nav class="navbar">
            <ul class="navbar-nav text-dark">
              ...
              ?>
              <a href="certificate.html" style = "text-decoration: none;"><li class="nav-item active">Certificate</li></a>
            ...
            <div class="col-md-12 text-center">
                <div class="card position-absolute bottom-0 end-0 m-3" style="width: 10rem;">
                    <div class="container text-center ">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#upload_file"><img src="assets/image/add_certificate_logo.png"
